document.addEventListener('DOMContentLoaded', function () {
  ...
  const ANIMATION_SELECTOR = '.animate-on-scroll, [data-animate], .feature-card, .section-header, .hero-content';
    ...
    if ('IntersectionObserver' in window) {
      ...
      elements.forEach(function (el, index) {
        ...
        if (!el.hasAttribute('data-delay')) {
          const siblings = el.parentNode ? el.parentNode.querySelectorAll(ANIMATION_SELECTOR) : [];
          let siblingIndex = 0;
          siblings.forEach(function (sib, i) { if (sib === el) siblingIndex = i; });
          const stagger = siblingIndex * 100;
          if (stagger > 0) el.setAttribute('data-delay', stagger);
        }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שומרת הבית משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '5921890f-2520-416d-9362-e3464cdff2c4',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '5921890f-2520-416d-9362-e3464cdff2c4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5921890f-2520-416d-9362-e3464cdff2c4';
